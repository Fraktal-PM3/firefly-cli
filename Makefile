...
build: ## Builds all go code
		cd ff && go build -ldflags="-X 'github.com/Fraktal-PM3/firefly-cli/cmd.BuildDate=$(DATE)' -X 'github.com/Fraktal-PM3/firefly-cli/cmd.BuildCommit=$(GITREF)'"
install: ## Installs the package
		cd ff && go install -ldflags="-X 'github.com/Fraktal-PM3/firefly-cli/cmd.BuildDate=$(DATE)' -X 'github.com/Fraktal-PM3/firefly-cli/cmd.BuildCommit=$(GITREF)'"
