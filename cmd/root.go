...
func Execute() {
	...
	rootCmd.PersistentFlags().StringP("stack-dir", "", path.Join(constants.StacksDir), fmt.Sprintf("directory where stacks are stored (default %s)", path.Join(constants.StacksDir)))
